  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 md:py-16 space-y-8 text-xs text-gray-300">
      ...
      <div className="p-4 rounded-xl bg-obsidian-card border border-titanium-border text-xs text-gray-400 space-y-1">
        ...
        <p>
          Draft cookie policy for CoderXP Milestone 1. Subject to legal compliance review.
        </p>
      </div>

      <div className="glass-panel p-8 rounded-2xl space-y-6 leading-relaxed">
        <h2 className="text-sm font-semibold text-white uppercase tracking-wider font-mono">1. Essential Cookies</h2>
        <p>
          CoderXP uses strictly essential cookies required to maintain authentication session state.
        </p>
      </div>
    </div>
  );
